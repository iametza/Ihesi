    ...
    if (zein == "gertukoenak") {
	    ...
	    for (var i = 0; i < len; i++) {
	        ...
	        if (lekuak[i].irudiaren_bidea) {
	        	$(zerrenda_id).append("<li data-icon='false' class='lekuak-zerrenda-li' data-id-lekua=" + lekuak[i].id + " data-lekua-id-herria=" + lekuak[i].id_herria + " data-id-lekua-lng=" + lekuak[i].gmaps_lng + " data-id-lekua-lat=" + lekuak[i].gmaps_lat + "><a href='xehetasunak.html'> <img id='koadro-txikia' src='" + window.appRootDir.fullPath + "/" + lekuak[i].irudia_src + "'> <h1>" + lekuak[i].izena + "</h1><p>" + lekuak[i].herriaren_izena + "   " + lekuak[i].distKM + "</p><span class='ui-li-count ui-btn-up-c ui-btn-corner-all'>" + lekuak[i].puntuazioa + "</span></a></li>");	        	
	        } else {
    	...
    	for (var i = 0; i < len; i++){
	        ...
	        if (results.rows.item(i).irudiaren_bidea) {
	        	$(zerrenda_id).append("<li data-icon='false' class='lekuak-zerrenda-li' data-id-lekua=" + results.rows.item(i).idElementua + " data-lekua-id-herria=" + results.rows.item(i).idHerria + " data-id-lekua-lng=" + results.rows.item(i).gmaps_lng + " data-id-lekua-lat=" + results.rows.item(i).gmaps_lat + "><a href='xehetasunak.html'> <img id='koadro-txikia' src='" + window.appRootDir.fullPath + "/" + irudia_src + "'> <h1>" + results.rows.item(i).izena + "</h1><p>" + results.rows.item(i).herriaren_izena + "   " + distKM + "</p><span class='ui-li-count ui-btn-up-c ui-btn-corner-all'>" + puntuazioa + "</span></a></li>");	        	
	        } else {
